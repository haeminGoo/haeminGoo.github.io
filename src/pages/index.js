...
const Home = () => {
  ...
  return (
    <main className="min-h-screen antialiased text-neutral-900 bg-neutral-100 sm:p-5">
      <SEO title="Resume" />
      <div className="container px-10 py-5 mx-auto bg-white shadow">
        <Header
        ...
        <div className="pb-2 my-5 border-b border-neutral-300 lg:flex">
